...
var
  Form1: TForm1;
  up,rigth,limit_rigth,limit_left,gameover,bonuslong,bonusvie,growsize,stop:boolean;
  ...
  i,j,jv,a,comptvie,al,av,b,c,d,dv,timebonusthor,k,t,time,longbarre:integer;
...
begin
  ...
  rigth:=true
    ...
    if Shapeball1.Left+Shapeball1.Width>=form1.width then
    rigth:=false;
  ...
  rigth:=true
    ...
    if Shapeball2.left+Shapeball2.Width>=form1.width then
    rigth:=false;
  ...
  rigth:=true
    ...
    if Shapeball3.Left+Shapeball3.Width>=form1.width then
    rigth:=false;
  ...
  rigth:=true
    ...
    if Shapeball4.Left+Shapeball4.Width>=form1.width then
    rigth:=false;
  ...
  rigth:=true
    ...
    if Shapeball5.Left+Shapeball5.Width>=form1.width then
    rigth:=false;
...
begin
  ...
  limit_left:=true;
  if Shapebarre1.left+Shapebarre1.Width>=form1.width  then
  limit_rigth:=true;
  for i:=1 to 20 do
  begin
  ...
  limit_left:=true;
  if Shapebarre2.left+Shapebarre2.Width>=form1.width  then
  limit_rigth:=true;
  for i:=21 to 40 do
  begin
  ...
  limit_left:=true;
  if Shapebarre3.left+Shapebarre3.Width>=form1.width  then
  limit_rigth:=true;
  for i:=41 to 60 do
  begin
  ...
  limit_left:=true;
  if Shapebarre4.left+Shapebarre4.Width>=form1.width  then
  limit_rigth:=true;
  for i:=61 to 80 do
  begin
  ...
  limit_left:=true;
  if Shapebarre5.left+Shapebarre5.Width>=form1.width  then
  limit_rigth:=true;
  for i:=81 to 122 do
  begin
...
begin
  ...
  begin
  if (Shapeball1.top >= Shapebarre1.top+40) and (comptvie=0)  then
  begin
    timer9.Enabled:=true;
  ...
  if (compt=0) and (gameover=true) then
  begin
  timer1.enabled:=false;
  timer9.Enabled:=true;
  label12.caption:='SCORE : '+inttostr(score);
  ...
  label8.left:=label8.left-50;
  playsound('claps.wav',0,SND_ASYNC);
  end;
  compt:=0;
  if stop=false then
  begin
...
begin
  if k=1 then
  begin
  if Shapebarre1.Width=300 then
  begin
  label9.left:=680;
  label9.caption:='TIME BONUS : '+inttostr(a);
  a:=a-1;
  ...
  begin
  label11.left:=680;
  label11.caption:='TIME BONUS : '+inttostr(timebonusthor);
  ...
  7:begin
    Shapeball1.brush.color:=clyellow;
    label11.font.color:=clyellow;
    end;
  6:Shapeball1.brush.color:=clred;
  5:Shapeball1.brush.color:=clgreen;
  4:Shapeball1.brush.color:=clred;
  3:begin
    Shapeball1.brush.color:=clblue;
    label11.font.color:=clblue;
    end;
  2:Shapeball1.brush.color:=clred;
  1:Shapeball1.brush.color:=clolive;
  0:Shapeball1.brush.color:=clred;
  end;

  end;
   if k=2 then
  begin
  if Shapebarre2.Width=300 then
  begin
  label93.left:=680;
  label93.caption:='TIME BONUS : '+inttostr(a);
  a:=a-1;
  ...
  begin
  label113.left:=680;
  label113.caption:='TIME BONUS : '+inttostr(timebonusthor);
  timebonusthor:=timebonusthor-1;
  end;
  if timebonusthor=-1 then
  begin
  ...
  8:Shapeball1.brush.color:=clblue;
  7:begin
    Shapeball2.brush.color:=clyellow;
    label113.font.color:=clyellow;
    end;
  6:Shapeball2.brush.color:=clred;
  5:Shapeball2.brush.color:=clgreen;
  4:Shapeball2.brush.color:=clred;
  3:begin
    Shapeball2.brush.color:=clblue;
    label113.font.color:=clblue;
    end;
  2:Shapeball2.brush.color:=clred;
  1:Shapeball2.brush.color:=clolive;
  0:Shapeball2.brush.color:=clred;
  end;

  end;
    if k=3 then
  begin
  if Shapebarre3.Width=300 then
  begin
  label94.left:=680;
  label94.caption:='TIME BONUS : '+inttostr(a);
  a:=a-1;
  ...
  begin
  label114.left:=680;
  label114.caption:='TIME BONUS : '+inttostr(timebonusthor);
  timebonusthor:=timebonusthor-1;
  end;
  if timebonusthor=-1 then
  begin
  ...
  8:Shapeball1.brush.color:=clblue;
  7:begin
    Shapeball3.brush.color:=clyellow;
    label114.font.color:=clyellow;
    end;
  6:Shapeball3.brush.color:=clred;
  5:Shapeball3.brush.color:=clgreen;
  4:Shapeball3.brush.color:=clred;
  3:begin
    Shapeball3.brush.color:=clblue;
    label114.font.color:=clblue;
    end;
  2:Shapeball3.brush.color:=clred;
  1:Shapeball3.brush.color:=clolive;
  0:Shapeball3.brush.color:=clred;
  end;
...
begin
 ...
 begin
  playsound('oops.wav',0,SND_ASYNC);
  c:=c+1;
  playoops:=false;
...
begin
 ...
 begin
  ...
  if (label11.left>250) and (bonusthor) and (dv=1) then
  begin
  label11.left:=label11.left-50;
  if (label11.left<=250) and (stopbonusthor) then
  begin
 ...
 begin
  ...
  begin
  timer8.Interval:=1;
  label113.left:=label113.left-50;
  end;
  if (label113.left>250) and (bonusthor) and (dv=1) then
  begin
  label113.left:=label113.left-50;
  if (label113.left<=250) and (stopbonusthor) then
  begin
  timer8.interval:=3000;
  stopbonusthor:=false;
  end;
 ...
 begin
  ...
  begin
  timer8.Interval:=1;
  label114.left:=label114.left-50;
  end;
  if (label114.left>250) and (bonusthor) and (dv=1) then
  begin
  label114.left:=label114.left-50;
  if (label114.left<=250) and (stopbonusthor) then
  begin
  timer8.interval:=3000;
  stopbonusthor:=false;
  end;
 ...
 begin
  ...
  begin
  timer8.Interval:=1;
  label115.left:=label115.left-50;
  end;
  if (label115.left>250) and (bonusthor) and (dv=1) then
  begin
  label115.left:=label115.left-50;
  if (label115.left<=250) and (stopbonusthor) then
  begin
  timer8.interval:=3000;
  stopbonusthor:=false;
  end;
 ...
 begin
  ...
  begin
  timer8.Interval:=1;
  label116.left:=label116.left-50;
  end;
  if (label116.left>250) and (bonusthor) and (dv=1) then
  begin
  label116.left:=label116.left-50;
  if (label116.left<=250) and (stopbonusthor) then
  begin
  timer8.interval:=3000;
  stopbonusthor:=false;
  end;
